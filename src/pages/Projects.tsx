    ...
    <>
      <div className="projectlist">
        <div className="project-div">
          ...
          <a
            href="https://github.com/ThomasQi3141/BUFF-Price-Drop-Alert-Script"
            target="_blank"
          >
            Price Drop Alert Bot
          </a>
          <p className="project-desc">
            Built using React, Express, Selenium, and SMTPlib, this app
            automatically web-scrapes BUFF marketplace, alerting you on the
            prices of your favourite skins through email.
          </p>
        </div>
        <div className="project-div">
          <svg
          ...
          <a href="https://github.com/ThomasQi3141/FitMetric" target="_blank">
            FitMetric
          </a>
          <p className="project-desc">
            FitMetric is an iOS app created for everyone hoping to gain a deeper
            understanding of the statistics of their body weight, from gym rats
        ...
        <div className="project-div">
          ...
          <a
            href="https://github.com/ThomasQi3141/Craigslist-Clone"
            target="_blank"
          >
            Craigslist Clone
          </a>
        ...
        <div className="project-div">
          ...
          <a
            href="https://github.com/ThomasQi3141/Bluetooth-Light-Switch"
            target="_blank"
          >
            Bluetooth Light Switch
          </a>
          <p className="project-desc">
            A wireless light switch built on the Arduino platform, controlled by
        ...
        <div className="project-div">
          ...
          <a
            href="https://github.com/ThomasQi3141/personal-website"
            target="_blank"
          >
            Personal Website
          </a>
          <p className="project-desc">
            Fully responsive website built using React, Typescript, and
            Bootstrap.
          </p>
        </div>
      </div>

      ...
      <div className="projectlist">
        <div className="project-div">
          ...
          <p className="project-desc">
            Built using Python, Selenium, and SMTPlib, this script automatically
            web-scrapes Netease BUFF marketplace and alerts you on the prices of
            your favourite skins through email.
          </p>
        </div>
        <div className="project-div">
          <svg
        ...
        <div className="project-div">
          ...
          <a
            href="https://github.com/ThomasQi3141/ThomasQi3141.github.io"
            target="_blank"
          >
            Personal Website
          </a>
